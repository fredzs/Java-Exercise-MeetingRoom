...
public class InsertReserveAction extends BaseAction {
	...
	public String execute() {
		...
		System.out.println("会议室"+" "+meeting_room+" "+date+" "+start_time+" "+end_time+"可用吗？"+available);
		if (available==0)
		{
			new ReserveDAO().createReserve(user_id, user_name, user_phone, teacher_name, 
